...
function editProject() {
  ...
  const targetProject = data.projects.find(
    (project) => project.id === editProjectModal.className
  );
...
function editTask() {
  ...
  const targetTask = data.tasks.find(
    (task) => task.id === editTaskModal.className
  );
  ...
  editTaskForm.elements['edit-t-description'].placeholder =
  ...
  editTaskForm.addEventListener('submit', function (e) {
    e.preventDefault();
    storageController.modifyTaskData(
...
const cardCreator = (() => {
  ...
  function renderTaskCard(index) {
    ...
    const parentProject = data.projects.find(
